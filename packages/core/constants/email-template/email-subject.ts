...
export class EmailSubjectTypeConstants {
    ...
    public readonly USER_ONBOARD_INVITATION: string =
        "Here is your new account in the organization " + this.tenantName;
    ...
    public readonly INVITED_ADMIN_USER_INVITE: string = "You are invited to join the "
        + this.tenantName + " team on Asgardeo";
    public readonly INVITED_ADMIN_USER_INVITE_TENANT1: string = "You are invited to join the "
        + this.tenantName + " team on Asgardeo";
    ...
    public readonly SUBSCRIPTION_UPGRADE_SALES_TEAM_NOTIFICATION: string = "[NEW LEAD - ASGARDEO]["+ 
    this.tenantName +"] Customer Subscription Upgrade"
}
