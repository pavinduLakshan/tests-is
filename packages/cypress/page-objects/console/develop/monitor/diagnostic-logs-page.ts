...
// PAGE LOCATORS
const LOGS_MAIN_CONTAINER = "[data-componentid=\"logs-page-log-entries-wrapper\"]";
const LOGS_TIME_RANGE_DROPDOWN = "[data-componentid=\"logs-page-timerange-dropdown\"]";
const LOGS_LAST_HOUR_MENU_ITEM = "Last hour";
const LOGS_SEARCH_BAR =  "[data-componentid=\"logs-page-search-input\"]";
const NO_LOGS_DISPLAY = "[data-componentid=\"logs-page-empty-search-placeholder\"]";
const LOGS_SEARCH_INPUT = "[data-componentid=\"logs-page-search-input\"]";
const SEARCH_BUTTON = "[data-componentid=\"logs-page-search-button\"]";
const RUN_QUERY_BTN = "[data-componentid=\"logs-page-search-button\"]";

/**
 * Class containing asgardeo console diagnostic logs page elements.
 * Console -> Develop -> Monitor
 */
export class DiagnosticLogsPage {
